...
const double mHe3 = 2.80941;
const double mH3 = 2.80943;
const double mC = 11.172;
const double mAl = 25.118;
...
int main(int argc, char ** argv)
{
	...
	double 	e_prl1[maxNTracks]		,	e_prl2[maxNTracks]	,
		...
		e_ytar[maxNTracks]		,	
		e_yptar[maxNTracks]		,	
		gold_e_yptar[maxNTracks]	,	
		e_xptar[maxNTracks]		,	
		gold_e_xptar[maxNTracks]	,	
		e_delta[maxNTracks]		,	
		gold_e_delta[maxNTracks]	,	
		e_mom[maxNTracks]		,	
		gold_e_mom[maxNTracks]		,	
		e_beta[maxNTracks]		,	
		gold_e_beta[maxNTracks]		,	
		e_x[maxNTracks]			,	
		e_y[maxNTracks]			,	
		e_z[maxNTracks]			,	
		e_px[maxNTracks]		,	
		e_py[maxNTracks]		,	
		e_pz[maxNTracks]		,	
		gold_e_px[maxNTracks]		,	
		gold_e_py[maxNTracks]		,	
		gold_e_pz[maxNTracks]		,	
		...
		BCMrenew[maxNTracks]		,	evtypebits[maxNTracks]  ;
	...
	sprintf(outfilename,"/chafs1/work1/tritium/coinc/inclusive_skim/%s_%s/skim_%d.root",argv[2],argv[3],runNumber);
	...
	for (int event=0 ; event < nEvents ; event++)
	{
		...
		memset( evtypebits		,-999		,sizeof(evtypebits)	);
